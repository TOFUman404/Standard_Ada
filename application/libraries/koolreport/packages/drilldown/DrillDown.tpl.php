...
<div id="<?php echo $this->name; ?>" style="<?php echo Utility::get($this->css,"panel"); ?>" class="drilldown panel panel-<?php echo $this->panelStyle; ?>">
    <div class="panel-heading">
        ...
        <span class="drilldown-title" style="<?php echo Utility::get($this->css,"title"); ?>"><?php echo $this->title; ?></span>
    </div>
    <div class="panel-body drilldown-body" style="<?php echo Utility::get($this->css,"body"); ?>">
        <?php
...
<script type="text/javascript">
    var <?php echo $this->name; ?> = new DrillDown("<?php echo $this->name; ?>",<?php echo json_encode($options); ?>);
